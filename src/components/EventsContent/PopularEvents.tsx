...
const events: Event[] = [
    { id: 1, name: 'Charros de Jalisco', price: 'Desde $0,000.00 MXN', image: popular1 },
    { id: 2, name: 'Grupo firme', price: 'Desde $0,000.00 MXN', image: popular2 },
    { id: 3, name: 'Cartel de Santa', price: 'Desde $0,000.00 MXN', image: popular3 },
